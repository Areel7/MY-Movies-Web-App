...
import { useClearCartMutation } from "../../redux/api/cart.js";
    ...
    <div className="fixed bottom-10 left-[30rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
      <section className="flex justify-between items-center ">
        ...
        <div className="flex justify-center items-center mb-[2rem]">
          <Link
            to="/"
            className="flex justify-center transition-transform transform hover:translate-x-2"
          >
          ...
          <Link
            to="/movies"
            className="flex item-center transition-transform transform hover:translate-x-2 ml-[1rem]"
          >
          ...
          <Link
            ...
            className="flex item-center transition-transform transform hover:translate-x-2 ml-[1rem]"
          >
            <MdOutlineShoppingCart className="mr-2 mt-[3rem]" size={26} />
            <span className="hidden nav-item-name mt-[3rem]">SHOP</span>
          </Link>
        </div>
        {/* section 2 */}
          ...
          {!userInfo && (
            <ul className="flex">
              <li>
                <Link
                  to="/login"
                  className="flex justify-center mt-5 transition-transform transform hover:translate-x-2 mb-[2rem]"
                >
              ...
              <li>
                <Link
                  to="/register"
                  className="flex justify-center mt-5 transition-transform transform hover:translate-x-2 mb-[1rem]"
                >
